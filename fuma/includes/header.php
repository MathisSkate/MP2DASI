...
<head>
    ...
    <title>FUMA</title>
    <meta name="description" content="FuMa ou 'Future de la marchandise', est un projet de recherche dans le domaine de la 
    logistique qui vise à réfléchir au transport de la marchandise de demain en prenant en compte entre autre l'accélération
     du commerce mondiale et l'exigence croissante du consommateur, qui demande toujours plus de traçabilité et de produits 
     issus des circuits courts. ">

    <meta name="keywords" content="fuma,FUMA,FuMa,projet fuma,Future de la marchandise,universite le havre,universite de rouen,
                                    normandie,IDIT">
    ...
    <!--Permet au caroussel de fonctionner -->
...
<body class="container-fluid" style="background-color:green;">
...
<div class="row">
    ...
    <nav id="menuFixed" class="sticky-top  navbar navbar-expand-lg  sticky-top logoPosition " style="font-size:1rem;"   >
        <a class="nav-item topnav " href="index.php">
            <img border="0" class="img-brand " alt="Logo"  
                  src="media/<?php echo $nameprojetgeneral?>_logo.png">
         </a>
            ...
            <ul class="navbar-nav flex-column">
                ...
                <?php
                    ...
                    if(($countTheses ==! 0) || ($_SESSION['isSuperAdmin'] == 1)){
                        ...
                        echo"<li class='nav-item'>
                             <a class='nav-link' href='theses.php'>$theses</a>
                             </li>";
                    }
