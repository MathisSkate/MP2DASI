...
<main class="pageAccueil col-lg-10">
    ...
    <section style="display: flex;width:100%;" class="content-container  row">

        <h1 class="ml-3"><?php echo $q[$_SESSION['lang']]['index']['a'] ?></h1>
                ...
                <div class="row">
                    <div class="col-xl-9 col-8 ">
                        <ul>
                            ...
                            <li>
                                <?php echo $q[$_SESSION['lang']]['index']['g1'] ?>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="row ml-3 mt-2">
            <p>
                <?php echo $q[$_SESSION['lang']]['index']['g2'] ?>
            </p>

            <p>
                <?php echo $q[$_SESSION['lang']]['index']['g3'] ?>
            </p>
        </div>
