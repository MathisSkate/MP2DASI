...
<main class="col-lg-10 ">
    ...
    <section class="content-container col-lg-12 row ">
        <div class="col-lg-12">
            <h2 class=""><?php echo $q[$_SESSION['lang']]['contact']['a']?>&nbsp;</h2>
        </div>
        <div class="ficheContact container-fluid col-lg-12 ">
            <section class="row justify-content-between ">
                <article class="col-lg-6 ">
                    <div class="col-lg-12 ">
                        <h2 style="font-size: 1.8em;" class="mt-1" ><?php echo $q[$_SESSION['lang']]['contact']['b']?></h2>
                    </div>
                    <?php
                    if (sizeof($reqUtil) == 0) {
                ...
                <article class="col-lg-6 text-center" style="margin: 0;" >
                    <!-- <img style="width: 30%; height: 60%;" src="media/image/logo/normandie.jpg" alt="Logo Normandie"> -->
                </article>
            </section>
            <br/>
            <section class="contact-form-container " >
                <form method="post" class="form-contact">
                    <section class="row">
                        <article class="col-lg-8 contact ">
                    ...
                    <button class="bouton-submit btn btn-block text-uppercase btn-info" type="submit"><?php echo $q[$_SESSION['lang']]['contact']['i']?></button>
                </form>
            </section>
        </div>
    </section>
