...
<body>
    <main class="form-tmplt pageInsc col-lg-12">
        ...
        <!-- problème sur ce bouton -->
        <a class="btn back-btn-1" href="index.php" role="button">Retour à la page d'accueil</a>
                ...
                <div class="col-sm-10 col-md-9 col-lg-8 mx-auto">
                    <div class="card card-signin">
                        <div class="card-body">
                            ...
                            <h5 class="card-title text-center">Inscription FuMa</h5>
                            <div class="message"></div>
                            <form enctype="multipart/form-data" method="post" class="form-signin">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-label-group flex-div">
                                            <p>Choisissez votre image d'avatar :</p>
                                            <div>
                                                <input type="file" id="avatar" name="inputAvatar" accept="image/png, image/jpeg">
                                            </div>
                                        </div>
                                    </div>
                                </div>
