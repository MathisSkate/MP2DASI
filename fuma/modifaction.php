...
$action = $_GET['action'];
$req = $bdd->prepare('SELECT tab1.numero_action, tab1.id_action, tab1.nom_action, tab2.nom_sous_action FROM ' . $nameprojetgeneral . '.action AS tab1 JOIN ' . $nameprojetgeneral . '.sous_action AS tab2 ON tab1.id_action = tab2.id_action WHERE tab1.id_action = :action');
    ...
    <section class="content-container col-lg-12 row">
        ...
        <div class="modifAction  container-fluid col-lg-12">
            <form method="POST" class="form-signin" >
                <section class="row">
                    <div class="col-lg-12">
                        <h1>Action <?php echo($reqAct[0]['numero_action']); ?>&nbsp;</h1>
                    </div>
                    <div class="col-lg-12">
