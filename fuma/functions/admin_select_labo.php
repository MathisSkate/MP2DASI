    ...
    echo "
        <tr>    
            ...
            echo "
                 <td>
                 <button 
             class=\"edit-data btn btn-success\" data-toggle=\"modal\" id='" . $donnees['id_laboratoire'] . "' data-target=\"#myModal\"contenteditable=\"false\" >Editer</button>
