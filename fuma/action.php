...
$action = $_GET['action'];
$req = $bdd->prepare('SELECT tab1.id_action, tab1.numero_action, tab1.nom_action, tab2.nom_sous_action FROM '.$nameprojetgeneral.'.action AS tab1 JOIN '.$nameprojetgeneral.'.sous_action AS tab2 ON tab1.id_action = tab2.id_action WHERE tab1.id_action = :action');
...
$req = $bdd->prepare('SELECT tab3.id_publication,tab3.titre_publication FROM commune.utilisateur AS tab1 JOIN ' . $nameprojetgeneral . '.utilisateur_detail AS tab2 ON tab1.id_utilisateur = tab2.id_utilisateur JOIN ' . $nameprojetgeneral . '.publication AS tab3 ON tab2.id_utilisateur_detail = tab3.id_utilisateur_detail WHERE tab3.id_action = :action');
$req->bindParam(':action', $action, PDO::PARAM_INT);
$req->execute();
$reqPub = $req->fetchAll();
...
?>
    <main class="col-lg-10">
        ...
        <section class="content-container col-lg-12 row">
            <div class="col-lg-12">
                <h2><?php echo $q['fr']['action']['a']." ".($reqAct[0]['numero_action']); ?>&nbsp;</h2>
            </div>
            <div class="col-lg-12">
            ...
            <div class="col-lg-12">
                ...
                for ($i = 0; $i < sizeof($reqAct); $i++) {
                  ...
                  " . $reqAct[$i]['numero_action'] . "." . $num_saction . "-" . $reqAct[$i]['nom_sous_action'] . "
                     </p>";
                    }else {
                    ...
                    <div class="card">
                        <div class="card-header" role="tab" id="headingTwo1">
                            <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx1" href="#collapseTwo1"
                               aria-expanded="false" aria-controls="collapseTwo1">
                                <h5 class="mb-0">
                                    <?php //echo $q[$_SESSION['lang']]['action']['c']." ".($reqAct[0]['id_action']); ?>
                                    <?php echo $q[$_SESSION['lang']]['action']['c']." ".($reqAct[0]['numero_action']); ?>
                        ...
                        <div id="collapseTwo1" class="collapse" role="tabpanel" aria-labelledby="headingTwo1"
                            ...
                            <div class="card-body">
                                <?php
                                if (sizeof($reqPub) == 0) {
                                    echo $q[$_SESSION['lang']]['action']['n']." ".($reqAct[0]['numero_action'])."";
                                } else {
                                    if (sizeof($reqPub) == 1) {
                                        echo "<p>". $q[$_SESSION['lang']]['action']['d'] ." " . ($reqAct[0]['numero_action']) . " ". $q[$_SESSION['lang']]['action']['e'] ." " . sizeof($reqPub) . " ".$q[$_SESSION['lang']]['action']['f']."</p>";
                                    } else {
                                        echo "<p>". $q[$_SESSION['lang']]['action']['d'] ." " . ($reqAct[0]['numero_action']) . " ". $q[$_SESSION['lang']]['action']['e'] ." " . sizeof($reqPub) . " ".$q[$_SESSION['lang']]['action']['g']."</p>";
                                    }
                    ...
                    <div class="card">
                        <div class="card-header" role="tab" id="headingTwo2">
                            <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx1" href="#collapseTwo21"
                               aria-expanded="false" aria-controls="collapseTwo21">
                                <h5 class="mb-0">
                                    <?php echo $q[$_SESSION['lang']]['action']['h']." ".($reqAct[0]['numero_action']); ?> <i class="fas fa-angle-down rotate-icon"></i>
                                </h5>
                            </a>
                        </div>
                        <div id="collapseTwo21" class="collapse" role="tabpanel" aria-labelledby="headingTwo21"
                            ...
                            <div class="card-body">
                                <?php
                                if (sizeof($reqThe) == 0) {
                                    echo $q[$_SESSION['lang']]['action']['o']." ".($reqAct[0]['numero_action'])."";
                                } else {
                                    if (sizeof($reqThe) == 1) {
                                        echo "<p>". $q[$_SESSION['lang']]['action']['d'] ." " . ($reqAct[0]['numero_action']) . " ". $q[$_SESSION['lang']]['action']['e'] ." " . sizeof($reqThe) . " ". $q[$_SESSION['lang']]['action']['i'] ."</p>";
                                    } else {
                                        echo "<p>". $q[$_SESSION['lang']]['action']['d'] ." " . ($reqAct[0]['numero_action']) . " ". $q[$_SESSION['lang']]['action']['e'] ." " . sizeof($reqThe) . " ". $q[$_SESSION['lang']]['action']['j'] ."</p>";
                                    }
