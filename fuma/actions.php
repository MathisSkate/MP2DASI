...
$req = $bdd->prepare('SELECT id_action, nom_action, numero_action from ' . $nameprojetgeneral . '.action');
$req->execute();
$reqAct = $req->fetchAll();
        ...
        for ($i = 0; $i < sizeof($reqAct); $i++) {
            ...
            if (sizeof($reqUtil) == 0) {
                echo "<section class=\"card action\">
                  ...
                  <a style='background-color:green; margin-top:15px;'  class=\"btn btn-primary\" href=\"action.php?action=" . $reqAct[$i]['id_action'] . "\">".$q[$_SESSION['lang']]['actions']['c']."</a>
                  </section>
                  </section>";
            } else {
                echo "<section class=\"card action\">
                ...
                /*1 personne*/
                    ...
                    echo "<div class=\"presSousAction\">
                        <a style='color:#7CBD33;' href=\"profil.php?mail=" . $reqUtil[0]['mail_utilisateur'] . "\">" . $reqUtil[0]['prenom_utilisateur'] . " " . $reqUtil[0]['nom_utilisateur'] . "</a>&nbsp;
                      </div>";
                }
                /*2 personnes*/
                    ...
                    for ($j = 0; $j < 2; $j++) {
                        echo "<div class=\"presSousAction\">
                        <a style='color:#7CBD33;' href=\"profil.php?mail=" . $reqUtil[$j]['mail_utilisateur'] . "\">" . $reqUtil[$j]['prenom_utilisateur'] . " " . $reqUtil[$j]['nom_utilisateur'] . "</a>&nbsp;
                      </div>";
                    }
                }
                /*3 personnes*/
                ...
                echo "<a style='background-color:green; margin-top:15px;' class=\"btn btn-primary\" href=\"action.php?action=" . $reqAct[$i]['id_action'] . "\">".$q[$_SESSION['lang']]['actions']['c']."</a>
                  </section>
                  </section>";
            }
        }
