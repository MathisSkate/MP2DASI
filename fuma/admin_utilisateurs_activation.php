...
$stmt = $bdd->prepare("SELECT tab1.nom_projet,tab1.id_projet FROM commune.projet AS tab1 ");
$stmt->execute();
?>
<main class="col-lg-10 pageAdminUserActivate">
    ...
    <section class="content-container row">
        ...
        <div class="col-lg-12">
            <table id="Users" class="w-100 table table-responsive-xl table-striped" >
                <thead >
                <tr>
                    <th scope="col">Nom</th>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 card-checkbox-container">
                                ...
                                while ($donnees = $stmt->fetch()){
                                    $idproject=$donnees['id_projet'];
                                    echo "
                               <div class=\"card col-lg-5 project-access\">
                                  <div class=\"card-header\">
                                        <label class=\"form-check-label\">
                                            <input  class=\"form-check-input check-project\" type=\"checkbox\" value=\"$idproject\" name=\"".$donnees['nom_projet']."-project\">
                                             ".$donnees['nom_projet']."
                                        </label>
                                  </div>
                                  <ul class=\"list-group list-group-flush\">
                                    <li class=\"list-group-item\">
                                        <label class=\"form-check-label\">
                                            <input  class=\"form-check-input child0$idproject \"  type=\"radio\" value=\"0\" name=\"".$donnees['nom_projet']."-radio\">
                                            Utilisateur
                                        </label>
                                    </li>
                                    <li class=\"list-group-item\">
                                        <label class=\"form-check-label\">
                                            <input  class=\"form-check-input child1$idproject \"  type=\"radio\" value=\"1\" name=\"".$donnees['nom_projet']."-radio\">
                                            Administrateur
                                        </label>
                                    </li>
                                  </ul>
