    ...
    <main class="col-lg-10">
        ...
        <section id="listPubli" class="listCard content-container col-lg-12 row">
            ...
            for ($i = 0; $i < sizeof($theses); $i++) {
                ...
                $date = dateFormat($theses[$i]['annee_these'], $_SESSION['lang'] == 'fr');
                echo "
              <section class=\"card-body publication\">
                <h2 class=\"card-title text-center\">".$theses[$i]['titre_these']."</h2>
                </section>
                  <section class=\"card-footer date\">
                    <p class=\"card-text \">".$q[$_SESSION['lang']]['theses']['c']." <strong>".$theses[$i]['soutenant_these']."</strong> ".$q[$_SESSION['lang']]['theses']['e']."<span class=\"font-italic\">".$date."</span></p>
