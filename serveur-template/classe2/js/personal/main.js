    ...
    $('#Labo').on('click', '.edit-data', function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#update_labo_Modal #inputDescLabo').val(data.description_laboratoire);
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data == 1) {
                        $('input').val("");
                        Swal.fire({
                            title: '<strong>Laboratoire modifié !</strong>',
                            type: 'success',
                            html:
                                '<p>Votre laboratoire a bien été mis a jour changé.</p>',
                            showCloseButton: true,
                            focusConfirm: false
                        })
                        window.location.reload();
    ...
    $('#Users').on('click', '.edit-data', function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                $(".action-button").attr("disabled", false);
                console.log(data);
                if (data.photo_utilisateur) {
                    $("#update_user_Modal .utilisateur-logo").toggleClass("showing-logo").attr("src", "../media_commun/avatar/" + data.photo_utilisateur);
                }
                else
                {
                    $("#update_user_Modal .utilisateur-logo").toggleClass("showing-logo").attr("src", "../media_commun/avatar/classe2_avatar.png");
                }
                ...
                $('#update_user_Modal #inputMission').val(data.mission_utilisateur);
                $('#update_user_Modal #inputPortrait').val(data.portrait_utilisateur);
                $("#update_user_Modal .radio").prop('checked', false);
                ...
                success: function (data) {
                    ...
                    if (data == 1) {
                        ...
                        Swal.fire({
                            ...
                            type: 'success',
                            html:
                                '<p>Votre utilisateur a bien été mis a jour changé.</p>',
                            showCloseButton: true,
                            focusConfirm: false
                        });
                        window.location.reload();
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data == 1) {
                        $('input').val("");
                        Swal.fire({
                            title: '<strong>Projet modifié !</strong>',
                            type: 'success',
                            html:
                                '<p>Votre projet a bien été mis a jour changé.</p>',
                            showCloseButton: true,
                            focusConfirm: false
                        });
                        window.location.reload();
