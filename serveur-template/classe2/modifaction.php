...
$fichiers = selectMedia($bdd, 'action', $action, 'pdf');
?>
                    ...
                    <div class="col-lg-12 control-group">
                        <p>
                            ...
                            <input type="url" name="inputLienAction" id="inputLienAction"
                                   ...
                                   maxlength="255" value="<?php echo ($reqAct[0]['media_action']);?>">
                        </p>
                    </div>
                    <div class="col-lg-12 control-group">
                        <p>Fichiers</p>
                        <div class="input-group mb-3">
                            <div class="custom-file">
                                ...
                                <label class="custom-file-label font-weight-light">Choisir vos fichiers (pdf)</label>
                            </div>
                        </div>
                        <div class="mediasFormActu">
                            ...
                            <figcaption style='color: white;' class='figure-caption text-center'>".$fichier['nom_media']."</figcaption>
                                                </a>
                                  <button id='".$fichier['id_media']."' class='mediasDelete btn btn-danger'>Supprimer</button></div>";
                                }
                            }
                            ?>
                        </div>
