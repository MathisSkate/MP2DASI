                    ...
                    <div class="modal-body">
                        ...
                        <form enctype="multipart/form-data" method="post" class="add_user">
                            ...
                            <div class="col-lg-7 mx-auto">
                                <div class="col-lg-12">
                                    <img src="" class="utilisateur-logo">
                                </div>
                                <div class="col-lg-12">
                                    <div class="custom-file" style="margin-bottom: 1rem;">
                                        <input type="file" id="inputLogoUtilisateurupdate" name="inputLogoUtilisateurupdate"
                                               accept="image/png, image/jpeg" class="custom-file-input">
                                        <label class="custom-file-label font-weight-light" for="inputLogoUtilisateurupdate">Choisir
                                            la photo de profil</label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-label-group flex-div">
                                        ...
                                        <select required class="userLabo-select" name="inputLabo">
                                            ...
                                            $stmt->bindParam(":projet", $nameprojetgeneral);
                                            $stmt->execute();
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-label-group flex-div">
                                        <p>Portrait de l'utilisateur : </p>
                                        <textarea class="form-control .inputPortrait" name="inputPortrait" id="inputPortrait"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                    ...
                    <div class="modal-body">
                        ...
                        <form enctype="multipart/form-data" method="post" class="add_user">
                            ...
                            <div class="col-lg-7 mx-auto">
                                ...
                                <div class="col-lg-12">
                                    <div class="custom-file" style="margin-bottom: 1rem;">
                                        <input type="file" id="inputLogoUtilisateuradd" name="inputLogoUtilisateuradd"
                                               accept="image/png, image/jpeg" class="custom-file-input">
                                        <label class="custom-file-label font-weight-light" for="inputLogoUtilisateuradd">Choisir
                                            la photo de profil</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-label-group flex-div">
                                        <p>Portrait de l'utilisateur : </p>
                                        <textarea class="form-control" name="inputPortrait" id="inputPortrait"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
...
<script>
    ClassicEditor
        .create( document.querySelector( '.inputPortrait' ) )
        .catch( error => {
            console.error( error );
        } );
</script>
