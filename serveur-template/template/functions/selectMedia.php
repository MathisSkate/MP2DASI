...
function selectMedia($bdd, $page, $id, $typeMedia)
{
    ...
    $reqMedias = $bdd->query("SELECT m.id_media, m.source_media FROM media AS m JOIN illustrer AS i ON m.id_media = i.id_media WHERE i." . $idPage . " = " . $id . " AND m.type_media= '" . $typeMedia . "' ");
    $reqMedias->execute();
