...
$req = $bdd->prepare('SELECT tab1.id_utilisateur,tab1.nom_utilisateur, tab1.prenom_utilisateur, tab1.photo_utilisateur, tab1.statut_utilisateur, tab1.site_utilisateur, tab1.etablissement_utilisateur, tab1.mail_utilisateur, tab1.mdp_utilisateur, tab1.mission_utilisateur, tab3.id_laboratoire, tab3.nom_laboratoire, tab3.abreviation_laboratoire
                        ...
                        <article class="col-lg-7 information">
                            ...
                            <div class="form-label-group">
                                ...
                                <select required class="labo-select form-control" name="inputLabo">
                                    <?php  echo"<option class=\"laboratoire\" selected=\"\" value=\"".$reqUtil[0]['id_laboratoire']."\">"?>
                                    <?php
                                    if (strlen($reqUtil[0]['nom_laboratoire']) == 0 || strlen($reqUtil[0]['abreviation_laboratoire']) == 0) {
                                        echo "Aucun laboratoire communiqué";
                                    } else {
                                        echo($reqUtil[0]['nom_laboratoire']);
                                    }
                                    ?>
                                    </option>
                                    <?php
                            ...
                            <div class="form-label-group flex-div">
                                ...
                                <?php
                                if ((isset($_SESSION['emailUser']))) {
                                    echo "<textarea class='form-control' required maxlength=\"350\" name=\"inputMission\" id=\"inputMissionwithValue\" placeholder=\"Mission\" value=\"".$reqUtil[0]['mission_utilisateur'] ."\" >".$reqUtil[0]['mission_utilisateur']."
                                      </textarea>";
                                } else {
                                    echo "<textarea class='form-control' required maxlength=\"350\" name=\"inputMission\" id=\"inputMission\" placeholder=\"Mission\"></textarea>";
                                }
                                ?>
                            </div>
