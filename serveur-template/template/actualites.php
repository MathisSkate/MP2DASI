...
$reqActu = $bdd->query('SELECT id_actualite, type_actualite, titre_actualite, description_actualite, resume_actualite, date_actualite, id_utilisateur_detail FROM '.$nameprojetgeneral.'.actualite order by date_actualite desc');
...
<main class="col-lg-10">
    ...
    <section id="listActu" class="listCard content-container col-lg-12 row">
        ...
        for ($i = 0; $i < sizeof($actualites); $i++) {
            ...
            if ($actualites[$i]['type_actualite'] == 'Evenement'){
            ...
            echo "
                  ...
                  <p class=\"card-text date\">".$q[$_SESSION['lang']]['actualites']['c']." ".$actualites[$i]['date_actualite']." ".$q[$_SESSION['lang']]['actualites']['d']." ".$auteur['prenom_utilisateur']." ".$auteur['nom_utilisateur']."</p>
