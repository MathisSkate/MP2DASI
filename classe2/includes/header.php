...
/*Pour afficher les actions*/
$req = $bdd->prepare("SELECT nom_projet FROM commune.projet");
$req->execute();
...
<head>
    <meta charset="UTF-8">
    <title>Corridors Logistiques : Application à la vallée de Seine et son environnement</title>
    ...
    <meta name="keywords" content="messages ais, classe, classe2, projet, recherche, corridors, logistique, vallée de la seine, normandie, université, le havre"/>
    ...
    <nav id="menuFixed" class="col-lg-2 sticky-top navbar navbar-expand-lg sticky-top logoPosition">
        ...
        <div class="navbar nav-full collapse" id="navbarNav">
            <ul class="navbar-nav flex-column">
                ...
                <?php
                if ((isset($_SESSION['emailUser'])) && ($reqProjet[0]['nom_projet'] == "classe2")) {
                    echo "<li class=\"nav-item\">
                            <a class=\"nav-link\" href=\"listFichier.php\">Données AIS</a>
                        </li>";
                }
                ?>
                <li class="nav-item">
