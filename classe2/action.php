...
/*
echo "SELECT m.id_media, type_media, source_media, nom_media FROM media AS m
JOIN illustrer AS i ON m.id_media = i.id_media
WHERE i.id_action = ".$action." order by nom_media";


echo "Media :  ".$media[0]['type_media'];
*/
?>
            ...
            for ($i = 0; $i < sizeof($mediaYoutube); $i++) {
                ...
                echo "<section class=\"content-container col-lg-12 row\">
                                                <object width=\"425\" height=\"355\">
                                                    <param name=\"movie\" value=\"" . $mediaYoutube[$i] . " \"></param>
                                                    <param name=\"wmode\" value=\"transparent\"></param>
                                                    <embed src=\"" . $mediaYoutube[$i] . "\" type=\"application/x-shockwave-flash\" wmode=\"transparent\" width=\"425\" height=\"355\"></embed>
                                                </object>
                                            </section>";
                echo "</div>";
                echo "</div>";
...
WHERE i.id_action = ".$action." order by nom_media";*/
                            ...
                            //echo "Media : ";print_r($media);

                            //Idem pour les fichiers PDF
                            $cpt = 0;
                            foreach ($media as $value){
                                if ($media[$cpt]['type_media'] == 'pdf'){
                                    echo "
