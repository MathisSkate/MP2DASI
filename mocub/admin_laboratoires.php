        ...
        <div class="col-lg-12">
            <table id="Labo" class="w-100 table table-responsive table-striped">
                ...
                <tr>
                    ...
                    <th scope="col">Projet(s) Lié(s)</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!-- Formulaire de mise à jour d'un laboratoire -->
                    <form novalidate enctype="multipart/form-data" method="post">
                        ...
                        <div class="form-group">
                            <p class="presProjet">
                                ...
                                $stmt->execute();
                                $reqP = $stmt->fetchAll();
                                $stmt = $bdd->prepare('SELECT tab2.id_projet FROM commune.appartenir AS tab2 WHERE tab2.id_laboratoire = 1' );
                                $stmt->execute();
                                $reqAppartenir = $stmt->fetchAll();
                                for ($i = 0; $i < sizeof($reqP); $i++) {
                                    echo "<div class=\"custom-control custom-checkbox\">
                                        <input type=\"checkbox\" name=\"projet[]\" class=\"custom-control-input\" id=\"CheckUpdate$i\" value=\"" . $reqP[$i]['id_projet'] . "\">
                                        <label class=\"custom-control-label\" for=\"CheckUpdate$i\">" . $reqP[$i]['nom_projet'] . "</label> 
                                        </div>";
                                }
                                ?>
                            </p>
                        ...
                        <div class="row justify-content-center">
                            <button type="submit" id="delete" name="delete" class="action-button delete-labo-button btn btn-primary bg-danger" value="delete">Supprimer le laboratoire</button>
                        </div>
                    </form>
                </div>
            </div>
                    ...
                    <form novalidate enctype="multipart/form-data" method="post">
                        ...
                        <div class="form-group">
                            <p class="presProjet">
                                ...
                                for ($i = 0; $i < sizeof($reqP); $i++) {
                                    echo "<div class=\"custom-control custom-checkbox\">
                                        <input type=\"checkbox\" name=\"projet[]\" class=\"custom-control-input\" id=\"CheckAdd$i\" value=\"" . $reqP[$i]['id_projet'] . "\">
                                        <label class=\"custom-control-label\" for=\"CheckAdd$i\">" . $reqP[$i]['nom_projet'] . "</label> 
                                        </div>";
                                }
                                ?>
                            </p>
