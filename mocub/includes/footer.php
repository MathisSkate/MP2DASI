...
<footer class="offset-3 row">
    ...
    <section class="col-lg-3">
        ...
        <section class="row">
            ...
            <div class="col-lg-6">
                <a href="https://www.univ-rouen.fr/"><img border="0" class="img-thumbnail" alt="Logo"
                                                          src="media/image/logo/LogoUnivRouen.png"></a>
            </div>
        </section>
    </section>
    <section class="col-lg-3">
        ...
        <div class="col-lg-12">
            <ul class="navbar-nav flex-column">
                <li class="nav-item">
                    <a href="#" target="_blank" class="nav-link"><?php echo $q[$_SESSION['lang']]['footer']['m-1']?></a>
                </li>
                <li class="nav-item">
                    <a href="#" target="_blank" class="nav-link"><?php echo $q[$_SESSION['lang']]['footer']['m-2']?></a>
                </li>
